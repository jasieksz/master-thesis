...
\textcolor{orange}{(WIP Czy muszę tu więcej wyjaśnić na czym polegają rozwiązania z cytacji?)}
...
\textcolor{orange}{(WIP: Pojęcie \textit{approval matrix} jest zdefiniowane w preliminaries)}
\end{proof}
...
\noindent \textbf{Results.} \indent Let us analyze the results visualized in Figure \ref{fig:detection:time:1}.
