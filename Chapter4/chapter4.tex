...
trends in the distribution of numbers of profiles with a selected property.
...
is how different are the TVCR profiles from the VR or the CR ones? 
...
Now, the halves still represent the number of deleted agents, but process of deletion is simultaneous for candidates and voters.
