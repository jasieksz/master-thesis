...
Having preferences matrix as input we have to provide a mapping of each agent (voter/candidate) to the point on real line
...
Final formulation of the ILP for recognising VCR property in the eleciton profile 
is shown in figure \ref{vcr-detection-ilp}.
Variables used by the program represent agent's point on real line and their radius. Additionally I use two binary variables 
$p$ and $q$ required by the indicator constraints.
