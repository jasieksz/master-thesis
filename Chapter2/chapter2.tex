...
\begin{figure}[t!]
    ...
    The first one illustrates the agents in the VCR model, i.e., every agent is represented by the point $x$ and radius $r$.
    The next two graphs visualize approval matrices of the election.
    Solid color corresponds to $1$ and white to $0$ in the cells of the matrix.
    The first one is presented in a natural order of the agents, and in the second one, agents are ordered by their point $x$.
    }
...
\begin{figure}[t!]
    \begin{subfigure}{0.49\textwidth}
      \centering
      \includegraphics[width=0.9\linewidth]{ncop-election-example.png}
    ...
    \begin{subfigure}{0.5\textwidth}
      \centering
      \includegraphics[width=\linewidth]{ncop-election-example-matrix-unordered.png}
